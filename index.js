...
document.getElementById("howToPlay").addEventListener("click", function () {
    ...
    document.getElementById("howToPlay").style.color = "white";
    
    document.getElementById("aboutPage").style.display="block";
    document.getElementById("content").innerHTML = "<h3> How to Play</h3> <b><i class='redtext'>Follow the step-by-step process to create a K9U account.</i></b><ul><li>Choose the size and breed you want to train.</li><br/> <li> Read through the specific information about the breed you chose. </li> <br/><li> After doggy simulation, you can take your quiz about the breed you chose. </li> <br/> <li>If you pass, we will certify you as a <b>master</b> of that breed</li></ul><br/><i> * Large size is locked and you need to pass both small and medium size breed</i> "
});
...
/*------------------------ user name will be used for last page -------------------------- */
